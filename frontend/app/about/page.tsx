          ...
          <div className="py-16 text-center">
            ...
            >
              <div className="flex items-center justify-center space-x-3 mb-6">
                ...
                <h1 className="text-4xl font-bold text-gray-900">About Drixai</h1>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-gray-600">
                <p>
                  Drixai was born from a simple observation: while AI models were becoming increasingly 
                ...
                <p>
                  Today, Drixai powers thousands of AI agents across industries, from customer service 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              These core values guide everything we do at Drixai
            </p>
          </motion.div>
