          ...
          <div className="py-8">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Learn how to build and deploy AI agents with AgentFlow</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <section id="quick-start" className="mb-12">
                ...
                <div className="prose prose-gray max-w-none">
                  <p className="text-gray-600 mb-6">
                    Get started with AgentFlow in just a few minutes. This guide will walk you through creating your first AI agent.
                  </p>
                  
                  <div className="bg-gray-50 rounded-lg p-6 mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Prerequisites</h3>
                    <ul className="space-y-2 text-gray-600">
                      <li>• An AgentFlow account (sign up for free)</li>
              ...
              <section id="available-tools" className="mb-12">
                ...
                <div className="prose prose-gray max-w-none">
                  <p className="text-gray-600 mb-6">
                    AgentFlow provides a comprehensive marketplace of tools to enhance your agents' capabilities.
                  </p>
              ...
              <section id="auth" className="mb-12">
                ...
                <div className="prose prose-gray max-w-none">
                  <p className="text-gray-600 mb-6">
                    Integrate AgentFlow into your applications using our REST API.
                  </p>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="border border-gray-200 rounded-lg p-4">
                      ...
                      <code className="bg-gray-100 px-2 py-1 rounded text-sm">https://api.agentflow.com/api/v1</code>
                    </div>
