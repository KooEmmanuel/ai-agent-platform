...
const testimonials = [
  {
    quote:
      "AgentFlow has transformed how we build AI assistants. The tool marketplace and playground make development incredibly fast.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "AgentFlow's real-time playground saved us weeks of testing. We can iterate and deploy faster than ever before.",
    name: "Lisa Thompson",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto px-4">
            See what our users are saying about AgentFlow
          </p>
        </div>
